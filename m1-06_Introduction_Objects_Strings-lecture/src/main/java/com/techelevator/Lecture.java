...
public class Lecture {
	...
	public static void main(String[] args) {
		...
		String substringExample = "The String is a String unless it isn't";
		String lower = substringExample.toLowerCase();
		System.out.println(lower);
		String sub = substringExample.substring(4, 10);
		System.out.println(sub);
		substringExample = "The String is a String unless it isn't";
		sub = substringExample.substring(4);
		System.out.println(sub);
