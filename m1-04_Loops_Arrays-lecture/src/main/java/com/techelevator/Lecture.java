...
public class Lecture {
    ...
    */
    ...
    /*
    6. Here, a variable is defined within a block. How can we get the value of that 
      outside of the block in order to return it? There are a couple of different ways of doing this, 
    ...
    */
    public int returnVariableFromBlock(int number) {
        ...
        } // the result variable disappears here  (Steve: Try printing it below)
        
       

        return myResult; // We want to return result here. How?
    }

    /*
    7. What will the variable result be at the end of the method? Change the number in the 
       logic expression so that it returns true.
    */
    ...
    */
    ...
    /*
    9. How many times do we go through this loop? Change the number in the logic expression so that 
    it returns true.
    */
